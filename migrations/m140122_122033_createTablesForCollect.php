...
class m140122_122033_createTablesForCollect extends EDbMigration
{
	public function safeUp()
	{
		$this->createTable('social_data', array(
            ...
            'data' => 'string NOT NULL COMMENT "raw json data of single post"',
        ...
        $this->addForeignKey('social_type_id', 'social_types', 'id', 'social_data', 'social_type_id', 'CASCADE', 'RESTRICT');
	}
